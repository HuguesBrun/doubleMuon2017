...
def Add_AdditionalBranches_NO( _PassingProbe, _ProbeCondition):
...
def FindTnPTreeName_N0( List_TnPTree, _PassingProbe, _ProbeCondition ):
    if _PassingProbe == "IsoMu24_OR_IsoTkMu24":
...
Ntuple_Data = cms.vstring( "file:"+TnPLocation)
...
for ID in IDS:
    ...
    for X,B in ALLBINS:
        ...
        #always on the top of the Tight2012
